	...
	class Robot {
		...
		update() {
			...
			for (let point of this.points) {
				...
				// ---- dance ---- increases speed and sizeon y axis
				if (this !== dancerDrag) {
	...
	class Link {
        ...
        //head shape w/ movement
          ...
          // gadget square color
			...
			this.image = stroke(
        //changes color opacity                             turns them white
				"hsl(" + parent.color + " ,80%, " + parent.light * this.light + "%)",
        //true adds moving gadgets false makes blank person
				false
			);
      //adds shadow darkness or opacity
...
//click on dancer people to make move
		move(e) {
